...
function initThemeToggle() {
  ...
  // Charger la préférence sauvegardée ou détecter la préférence système
...
function setTheme(themeName) {
  ...
  localStorage.setItem('monvote-theme', themeName);
...
function loadSavedTheme() {
  const savedTheme = localStorage.getItem('monvote-theme') || 'default';
  setTheme(savedTheme);
}
