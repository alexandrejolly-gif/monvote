...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Identifier les nouveaux candidats
    const existingNames = new Set(existingCandidats.map(c => c.nom.toUpperCase()));
    const newCandidats = searchedCandidats.filter(c => !existingNames.has(c.nom.toUpperCase()));
